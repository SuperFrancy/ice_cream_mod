...
public class IceCreamMachineGMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public IceCreamMachineGMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IceCreamModModMenus.ICE_CREAM_MACHINE_G.get(), id);
