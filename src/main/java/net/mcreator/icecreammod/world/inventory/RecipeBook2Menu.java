...
public class RecipeBook2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RecipeBook2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IceCreamModModMenus.RECIPE_BOOK_2.get(), id);
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, -97, 67) {
		...
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, -97, 40) {
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, -97, 22) {
		...
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, -32, 40) {
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof RecipeBook2Menu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			AllRecipe2Procedure.execute(entity);
		}
	}
}
