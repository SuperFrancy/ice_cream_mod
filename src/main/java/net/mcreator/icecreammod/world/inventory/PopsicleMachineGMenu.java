...
public class PopsicleMachineGMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PopsicleMachineGMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IceCreamModModMenus.POPSICLE_MACHINE_G.get(), id);
