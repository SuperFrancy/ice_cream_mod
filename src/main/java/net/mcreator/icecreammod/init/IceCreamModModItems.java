...
import net.mcreator.icecreammod.item.VanillaIceCreamBallItem;
...
import net.mcreator.icecreammod.item.SweetBerryIceCreamBallItem;
...
import net.mcreator.icecreammod.item.MelonIceCreamBallItem;
...
import net.mcreator.icecreammod.item.GlowBerryIceCreamBallItem;
...
import net.mcreator.icecreammod.item.ChorusIceCreamBallItem;
...
import net.mcreator.icecreammod.item.ChocolateIceCreamBallItem;
...
import net.mcreator.icecreammod.item.CarrotIceCreamBallItem;
...
import net.mcreator.icecreammod.item.BeetrootIceCreamBallItem;
...
import net.mcreator.icecreammod.item.AppleIceCreamBallItem;
...
public class IceCreamModModItems {
	...
	public static final RegistryObject<Item> VANILLA_ICE_CREAM_BALL = REGISTRY.register("vanilla_ice_cream_ball", () -> new VanillaIceCreamBallItem());
	...
	public static final RegistryObject<Item> CHOCOLATE_ICE_CREAM_BALL = REGISTRY.register("chocolate_ice_cream_ball", () -> new ChocolateIceCreamBallItem());
	...
	public static final RegistryObject<Item> APPLE_ICE_CREAM_BALL = REGISTRY.register("apple_ice_cream_ball", () -> new AppleIceCreamBallItem());
	...
	public static final RegistryObject<Item> CARROT_ICE_CREAM_BALL = REGISTRY.register("carrot_ice_cream_ball", () -> new CarrotIceCreamBallItem());
	...
	public static final RegistryObject<Item> BEETROOT_ICE_CREAM_BALL = REGISTRY.register("beetroot_ice_cream_ball", () -> new BeetrootIceCreamBallItem());
	...
	public static final RegistryObject<Item> MELON_ICE_CREAM_BALL = REGISTRY.register("melon_ice_cream_ball", () -> new MelonIceCreamBallItem());
	...
	public static final RegistryObject<Item> SWEET_BERRY_ICE_CREAM_BALL = REGISTRY.register("sweet_berry_ice_cream_ball", () -> new SweetBerryIceCreamBallItem());
	...
	public static final RegistryObject<Item> GLOW_BERRY_ICE_CREAM_BALL = REGISTRY.register("glow_berry_ice_cream_ball", () -> new GlowBerryIceCreamBallItem());
	...
	public static final RegistryObject<Item> CHORUS_ICE_CREAM_BALL = REGISTRY.register("chorus_ice_cream_ball", () -> new ChorusIceCreamBallItem());
