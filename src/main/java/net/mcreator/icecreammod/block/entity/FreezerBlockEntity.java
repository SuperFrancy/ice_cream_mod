...
public class FreezerBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public FreezerBlockEntity(BlockPos position, BlockState state) {
		super(IceCreamModModBlockEntities.FREEZER.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new FreezerGMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
